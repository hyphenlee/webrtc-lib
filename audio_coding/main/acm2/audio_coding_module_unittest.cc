...
#include "audio_coding/main/acm2/acm_receive_test.h"
#include "audio_coding/main/acm2/acm_send_test.h"
...
// See https://code.google.com/p/issues/detail?id=4768 for details.
